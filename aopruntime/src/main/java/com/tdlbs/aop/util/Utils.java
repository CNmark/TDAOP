...
public final class Utils {
    ...
    public static String toString(Object object) {
        if (TDLogger.getISerializer() != null) {
            return TDLogger.getISerializer().toString(object);
        } else {
...
//        return TDAOP.getICacheKeyCreator().getCacheKey(joinPoint);
//    }
