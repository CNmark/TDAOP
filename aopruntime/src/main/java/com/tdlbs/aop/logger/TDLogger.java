...
public final class TDLogger {
     ...
     * 默认tag
     */
    public final static String DEFAULT_LOG_TAG = "[TDLogger]";
    /**
    ...
    public static void setPriority(int priority) {
        TDLogger.sLogPriority = priority;
    }
    ...
    public static void setISerializer(Strings.ISerializer sISerializer) {
        TDLogger.sISerializer = sISerializer;
    }
